			...
			<div class="find_idpw_wrap">
				<form name="inputForm" id="inputForm" action="">
					...
					<ul class="nav nav-tabs">
						...
						<li><a href="/find_pw.jsp">비밀번호 재설정</a></li>
					</ul>

					<div class="tab-content">
						<div id="find_id" class="tab-pane fade in active">
							<!-- 필수사항 -->
							<section class="essential_info">
								<div class="sub_title_b">본인확인</div>
								<div class="sub_title">이름 / 연락처 / 이메일의 경우 등록된 정보를 입력해주세요.
								</div>
							...
							<section class="join_write_btn">
								...
								<button type="button" class="box_type01 indigo_box right" id="pop_btn_find">아이디 찾기</button>
								...
								<div id="popup_find" class="popup">
									...
									<div class="popup_content">
										...
										<div class="con">
											<p class="des">고객님의 정보와 일치하는 아이디입니다.</p>
											<p class="id">user_id</p>
										</div>
										<button type="button" class="">로그인 하기</button>
									</div>
								</div>
