...
<div class="container-fluid">
	...
	<div class="row content">
		...
		<div class="col-sm-10 p0">
			...
			<div class="container-fluid content p10">
				<h4 class="n_bold">가입승인<span>필터 내용중 한개 이상의 조건은 필수로 입력되어야 합니다.</span></h4>

				<div id="grid" class="mt20">
					<div class="grid_des">
			...
			<div class="btn_wrap p10">
				<button type="button" class="light_gray mr10 n_light" id="withdraw">거절</button>
				<button type="button" class="deep_gray n_light" id="save">승인</button>
			</div>
